...
export class User_Blood_Detail extends Component {
    constructor(props)
    {
        super(props)
        this.state={
  ...
  render() {
    ...
    if (!fontsLoaded) {
      ...
      return (
          ...
          <View style={{width:"60%"}}>
          <Text style={{fontSize:14,fontWeight:500,color:"#FF5151",textAlign:"right",marginBottom:1,fontFamily:'Outfit_Medium',marginRight:"5%"}}>{this.props.blood_grp}</Text>
            <Text style={{color:"rgba(0, 125, 254, 1)",fontSize:13,fontWeight:400,marginTop:-5,fontFamily:'Outfit_Regular'}}>{this.props.reg}</Text>
